...
export const LOAD_MORE_PHONES_START = 'LOAD_MORE_START'
...
export const FETCH_CATEGOREIS_START = 'FETCH_CATEGOREIS_START'
export const FETCH_CATEGOREIS_SUCCESS = 'FETCH_CATEGOREIS_SUCCESS'
export const FETCH_CATEGOREIS_FAILURE = 'FETCH_CATEGOREIS_FAILURE'